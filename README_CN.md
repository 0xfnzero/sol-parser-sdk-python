...
|----------|------|------|
| **PumpFun** | | |
| `python examples/pumpfun_trade_filter.py` | PumpFun 交易过滤（Buy/Sell/BuyExactSolIn/Create），附带延迟指标 | [examples/pumpfun_trade_filter.py](https://github.com/0xfnzero/sol-parser-sdk-python/blob/main/examples/pumpfun_trade_filter.py) |
| **PumpSwap** | | |
| `python examples/pumpswap_low_latency.py` | PumpSwap 超低延迟，含每笔交易 + 10 秒汇总统计 | [examples/pumpswap_low_latency.py](https://github.com/0xfnzero/sol-parser-sdk-python/blob/main/examples/pumpswap_low_latency.py) |
| **多协议** | | |
| `python examples/multi_protocol_grpc.py` | 同时订阅所有 DEX 协议 | [examples/multi_protocol_grpc.py](https://github.com/0xfnzero/sol-parser-sdk-python/blob/main/examples/multi_protocol_grpc.py) |
